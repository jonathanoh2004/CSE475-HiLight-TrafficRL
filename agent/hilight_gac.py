...
class GraphAttentionConcat(nn.Module):
    ...
    def forward(self, x, neighbor_index):
        ...
        assert feat_dim == self.in_dim, f"Expected in_dim={self.in_dim}, got {F}"
